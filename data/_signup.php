...
$validation_signup[FIRST_NAME][IS_VALID] = (false !== filter_var($validation_signup[EMAIL][VALUE], FILTER_SANITIZE_STRING));
...
$validation_signup[STREET_NUM][IS_VALID] = (false !== filter_var($validation_signup[STREET_NUM][VALUE], FILTER_SANITIZE_STRING));
...
//Validation DOB
$validation_signup[DOB][VALUE] = filter_input(INPUT_POST, ZIP, FILTER_SANITIZE_STRING);
