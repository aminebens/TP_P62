...
// Validation du prenom
    ...
    $validation_signup[FIRST_NAME][IS_VALID] = (false !== filter_var($first_name, FILTER_SANITIZE_STRING)
        ...
        && $first_name != '');
    $validation_signup[FIRST_NAME][ERR_MSG] = ($validation_signup[FIRST_NAME][IS_VALID]) ? '' : ERR_MSG;
...
//Validation du nom
    ...
    $validation_signup[LAST_NAME][ERR_MSG] = ($validation_signup[LAST_NAME][IS_VALID]) ? '' : ERR_MSG;
...
// Validation de l'email
    ...
    $validation_signup[EMAIL][IS_VALID] = (false !== filter_var($email, FILTER_VALIDATE_EMAIL)
        && strlen($email) <= 60
        && $email != '');
    $validation_signup[EMAIL][ERR_MSG] = ($validation_signup[EMAIL][IS_VALID]) ? '' : ERR_MSG;
...
// Validation du numero de rue
    ...
    $validation_signup[STREET_NUM][ERR_MSG] = ($validation_signup[STREET_NUM][IS_VALID]) ? '' : ERR_MSG;
...
// Validation de la rue
    ...
    $validation_signup[STREET][IS_VALID] = (false !== filter_var($street, FILTER_SANITIZE_STRING)
        ...
        && $street != '');
    $validation_signup[STREET][ERR_MSG] = ($validation_signup[STREET][IS_VALID]) ? '' : ERR_MSG;
...
// Validation de la ville
    ...
    $validation_signup[CITY][IS_VALID] = (false !== filter_var($city, FILTER_SANITIZE_STRING)
        && strlen($city) <= 60
        && $city != '');
    $validation_signup[CITY][ERR_MSG] = ($validation_signup[CITY][IS_VALID]) ? '' : ERR_MSG;
...
// Validation de la province
    ...
    $validation_signup[PROVINCE][IS_VALID] = (false !== filter_var($province, FILTER_SANITIZE_STRING)
        && strlen($province) <= 45
        && $province != '');
    $validation_signup[PROVINCE][ERR_MSG] = ($validation_signup[PROVINCE][IS_VALID]) ? '' : ERR_MSG;
...
// Validation ZIP
    ...
    $validation_signup[ZIP][IS_VALID] = (false !== filter_var($postal_code, FILTER_SANITIZE_STRING)
        ...
        && $postal_code != '');
    $validation_signup[ZIP][ERR_MSG] = ($validation_signup[ZIP][IS_VALID]) ? '' : ERR_MSG;
...
//Validation DOB
    ...
    $validation_signup[DOB][ERR_MSG] = ($validation_signup[DOB][IS_VALID]) ? '' : ERR_MSG;
